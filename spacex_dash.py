# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 11:27:08 2022
...
def get_pie_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        fig = px.pie(filtered_df, values='class',
                     names='Launch Site',
                     title='Mission Successes by Launch Site',
                     labels={'class': 'Mission Successes'})
        return fig
    else:
        #return the outcomes piechart for a selected site
        filtered_df = filtered_df[filtered_df['Launch Site']==entered_site]
        filtered_df['fix'] = filtered_df['class']*0+1
        fig = px.pie(filtered_df, values='fix',
                     names='class',
                     title='Mission Successes/Failures for Launch Site %s' %entered_site,
                     labels={'class': 'Mission Successes'})
        return fig
